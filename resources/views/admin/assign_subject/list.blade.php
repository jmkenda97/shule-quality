              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" value="{{Request::get('class_name')}}"  name="class_name" placeholder="className">
                  </div> 
                     ...
                     <tbody>
                      ...
                      <tr>
                       ...
                       <td>
                        ...
                        <td><a href="{{url('admin/assign_subject/edit/' .$value->id)}}" class="btn btn-primary">edit</a>
                        <td><a href="{{url('admin/assign_subject/edit_single/' .$value->id)}}" class="btn btn-primary">edit single</a>
