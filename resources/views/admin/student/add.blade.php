              ...
              <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{old('name')}}" required name="name" placeholder="First Name">
                    <div style="color: lightcoral">{{$errors->first('name')}}</div>
                  </div> 
                    <div class="form-group col-md-6">
                    <label>Last Name <span style="color: lightcoral">*</span></label>
                    <input type="text" class="form-control" value="{{old('last_name')}}" required name="last_name" placeholder="Last Name">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{old('admission_number')}}" required name="admission_number" placeholder="Admission Number">
                    <div style="color: lightcoral">{{$errors->first('admission_number')}}</div>
                  </div> 
                   <div class="form-group col-md-6">
                    <label>Roll Number <span style="color: lightcoral">*</span></label>
                    <input type="text" class="form-control" value="{{old('roll_number')}}" required name="roll_number" placeholder="roll Number">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select class="form-control"  required name="class_id">
                        ...
                        @foreach($getClass as $value)
                          <option {{(old('class_id')==$value->id) ? 'selected':''}} value="{{$value->id}}">{{$value->class_name}}</option>
                        @endforeach
                    </select>
                 ...
                 <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control" value="{{old('date_of_birth')}}" required name="date_of_birtth" placeholder="date_of_birth">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{old('mobile_number')}}" required name="mobile_number" placeholder="mobile_number">
                    <div style="color: lightcoral">{{$errors->first('mobile_number')}}</div>
                  </div> 
          
                   <div class="form-group col-md-6">
                    <label>Admission Date <span style="color: lightcoral">*</span></label>
                    <input type="date" class="form-control" value="{{old('admission_date')}}" name="admission_date" placeholder="admission date">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{old('blood_group')}}"  name="blood_group" placeholder="blood_group">
                      <div style="color: lightcoral">{{$errors->first('blood_group')}}</div>
                  </div> 

                   <div class="form-group col-md-6">
                    <label>Weight <span style="color: lightcoral">*</span></label>
                    <input type="text" class="form-control" value="{{old('height')}}" required name="weight" placeholder="weight">
                    <div style="color: lightcoral">{{$errors->first('weight')}}</div>
                  </div> 
                   <div class="form-group col-md-6">
                    <label>Height <span style="color: lightcoral">*</span></label>
                    <input type="text" class="form-control" value="{{old('weight')}}" required name="height" placeholder="height">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <select class="form-control" required name="status">
                        ...
                        <option {{(old('active')=='0') ? 'selected':''}} value="0">active</option>
                        <option {{(old('inactive')=='1') ? 'selected':''}} value="1">inactive</option>
                    </select>
